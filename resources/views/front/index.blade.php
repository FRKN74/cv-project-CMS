                    ...
                    <div class="col-xs-12 col-sm-12">
                      ...
                      <div class="portfolio-content">
                        ...
                        <div class="portfolio-grid three-columns">
                          ...
                          @foreach ($projeall as $all)
                          <figure class="item standard" data-groups='["category_all", "category_detailed"]'>
                            <div class="portfolio-item-img">
                              <img src="{{asset($all->image1)}}" alt="Media Project 2" title="" />
                              <a href="{{ route('protfoy',$all->slug)}}" class="ajax-page-load"></a>
                            </div>

                            <i class="far fa-file-alt"></i>
                            <h4 class="name">{{$all->title}}</h4>
                            <span class="category">{{$all->getProje->kategori_adi}}</span>
                          </figure>
                          @endforeach
                ...
                <div class="section-content">
                  ...
                  <div class="row">
                    ...
                    @endforeach
                      ...
                      <div class="block-title">
                        <h3>Size nasıl <span>Yardım Edebilirim?</span></h3>
                      </div>
                      ...
                      <form id="contact_form" class="contact-form" action="https://lmpixels.com/demo/breezycv/light/1/contact_form/contact_form.php" method="post">
                        ...
                        <div class="controls two-columns">
                          ...
                          <input type="submit" class="button btn-send" value="Gönder">
                        </div>
                      </form>
                    </div>
                    <!-- End of Contact Form -->
