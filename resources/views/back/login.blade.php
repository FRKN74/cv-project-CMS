...
<head>
    ...
    <meta name="BF Design" content="BF Design">
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-xl-7"><img class="bg-img-cover bg-center" src="{{ asset('back') }}/assets/images/login/2.jpg" alt="looginpage"></div>
          <div class="col-xl-5 p-0">
            <div class="login-card">
              <form action="{{ route('login.post') }}" method="POST" class="theme-form login-form">
                @csrf
                <h4>Admin Panel</h4>
                <h6>Tekrar Hoşgeldin! Panele Ulaşmak için giriş yap.</h6>
                <div class="form-group">
                  <label>Kullanıcı adı</label>
                  <div class="input-group"><span class="input-group-text"><i class="fa-solid fa-user"></i></span>
                    <input class="form-control" type="text" name="kullanici_adi" required="" placeholder="kullanıcı adı girinizz">
                  </div>
                </div>
                <div class="form-group">
                  <label>Şifre</label>
