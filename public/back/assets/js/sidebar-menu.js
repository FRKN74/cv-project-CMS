...
if ($('#pageWrapper').hasClass('compact-wrapper')) {
    jQuery('.sidebar-title').append('<div class="according-menu"></div>');
    jQuery('.sidebar-title').click(function () {
        jQuery('.sidebar-title').removeClass('active').find('div').replaceWith('<div class="according-menu"></div>');
    ...
    jQuery('.submenu-title').click(function () {
        jQuery('.submenu-title').removeClass('active').find('div').replaceWith('<div class="according-menu"></div>');
    ...
    $(window).on('load', function(){ 
        ...
        function checkPosition() {
            ...
            jQuery('.sidebar-title').click(function () {
                ...
                jQuery('.sidebar-title').find('div').replaceWith('<div class="according-menu"></div>');
                jQuery('.sidebar-submenu, .menu-content').slideUp('normal');
                if (jQuery(this).next().is(':hidden') == true) {
                    jQuery(this).addClass('active');
                    jQuery(this).find('div').replaceWith('<div class="according-menu"></div>');
    ...
    $(".sidebar-wrapper nav ul>li a").filter(function () {
        ...
        if (link) {
            if (current.indexOf(link) != -1) {
                ...
                $(this).parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu"></div>');
                return false;
            }
        }
    });
    ...
    $(".sidebar-wrapper nav #sidebar-menu ul .simplebar-mask li a").filter(function () {
        ...
        if (link) {
            if (current.indexOf(link) != -1) {
                ...
                $(this).addClass('active');
                $(this).parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu"></div>');
                $(this).parent().parent().parent().parent().parent().children('a').find('div').replaceWith('<div class="according-menu"></div>');
                return false;
            }
        }
    });
